  ...
  return (
    <div className="flex items-center justify-center w-24 lg:w-[130px] h-24 lg:h-[130px] rounded-full border border-white bg-transparent">
      <div
        ...
        className="flex items-center justify-center w-16 lg:w-[90px] h-16 lg:h-[90px] rounded-full border border-white bg-transparent hover:cursor-pointer transition-transform transform hover:scale-110 hover:opacity-90 hover:shadow-lg duration-700 ease-in-out"
      >
        <Image
          src={DownloadIcon}
